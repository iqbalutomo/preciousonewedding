...
<head>
	<meta charset="UTF-8">
	<title>Careers | The Precious One Wedding</title>
    ...
    <div id="intro" class="view">
        ...
        <div class="">
            ...
            <div class="title-header">
                ...
                <!-- Description -->
                <h5 class="light center white-text">Menjadi bagian dari precious one</h5>
        	</div>
          ...
          <?php
            foreach ($career as $rowcareer) {
              ...
              <tr>
                ...
                <td class="right"><?=$rowcareer->location;?></td>
                <td><a href="<?=site_url('home/career_detail/'.$rowcareer->id)?>" class="gold-text">Details</a></td>
              </tr>
              <?php
            }
          ?>
...
<!-- END FOOTER -->
	...
	<!-- Client JS -->
	<script type="text/javasript" src="<?=base_url('js/custom_careers.js');?>"></script>
